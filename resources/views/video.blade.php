    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class='top-margin-auto'>
                ...
                <a href="/addvideo" class="btn btn-outline-primary mb-3" data-bs-toggle="modal"
                                    ...
                                    <form action="/addvideos" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" class="form-control"
                                                placeholder="Ism kiriting..." id="exampleInputEmail1"
                                                aria-describedby="emailHelp">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputPassword1" class="form-label">Link</label>
                                            <input type="text" name="file" class="form-control"
                                                placeholder="Link kiriting..." id="exampleInputPassword1">
                                        </div>
                                        <br>
                        ...
                        @foreach ($ved as $dd)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <iframe width="300" height="150" src="{{ $dd->file }}"
                                ...
                                <td>
                                    <a href="" class='btn btn-danger' data-bs-toggle="modal"
                                        data-bs-target="#exampleModal4{{ $dd->id }}">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <a href="/delvideo/{{ $dd->id }}" class="btn btn-primary"
                                    ...
                                    <button class='btn btn-primary editbtn' value="{{ $dd->id }}"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal3{{ $dd->id }}">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form action="/editvideo/{{ $dd->id }}" method="POST">
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="file" id="code"
                                                                value="{{ $dd->file }}" class="form-control"
                                                                id="exampleInputEmail1" aria-describedby="emailHelp">
                                                        </div>
