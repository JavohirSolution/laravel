                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="/newboy" class="nav-link active">
                                            <img src="salom/dist/img/user8-128x128.jpg" width="20"
                                                alt="">
                                    ...
                                    <div class="card-body box-profile">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid img-circle"
                                                src="salom/dist/img/user8-128x128.jpg" alt="User profile picture">
                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="row">
                                                                            <div class="col-sm-6 col-md-5">
                                                                                <div class="about-img">
                                                                                    <img src="salom/dist/img/user8-128x128.jpg"
                                                                                        class="img-fluid yurbtn-clasws rounded b-shadow-a"
                                                                                        alt="">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-sm-6 col-md-7">
                                                                                <div class="about-info">
                                                                                    @foreach ($user as $dd)
                                                                                        <p><span class="title-s">Name:
                                                                                            </span><span>{{ $dd->name }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Company:
                                                                                            </span>
                                                                                            <span>{{ $dd->company }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Job:
                                                                                            </span>
                                                                                            <span>{{ $dd->job }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Country:
                                                                                            </span>
                                                                                            <span>{{ $dd->country }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Address:
                                                                                            </span>
                                                                                            <span>{{ $dd->address }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Phone:
                                                                                            </span>
                                                                                            <span>{{ $dd->phone }}</span>
                                                                                        </p>
                                                                                        <p><span class="title-s">Email:
                                                                                            </span>
                                                                                            <span>{{ $dd->email }}</span>
                                                                                        </p>
                                                                                    @endforeach
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="about-me pt-4 pt-md-0">
                                                                            ...
                                                                            <p class="lead">
                                                                                My name is Javohir. I was born in
                                                                                Uzbekistan. I still live in Uzbekistan.
                                                                                I have been learning programming for
                                                                                half a year,<br>
                                            ...
                                            @if (Auth::User()->admin == 1)
                                                <div class="tab-pane" id="settings">
                                                    <form action="/Userprofile/{{ $dd->id }}" method="post">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="company"
                                                                    value="{{ $dd->company }}" class="form-control"
                                                                    id="inputName" placeholder="Company">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputName"
                                                                class="col-sm-2 col-form-label">Job</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="job"
                                                                    value="{{ $dd->job }}" class="form-control"
                                                                    id="inputName" placeholder="Job">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputName"
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="country"
                                                                    value="{{ $dd->country }}" class="form-control"
                                                                    id="inputName" placeholder="Country">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputName"
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" name="address"
                                                                    value="{{ $dd->address }}" class="form-control"
                                                                    id="inputName" placeholder="Address">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="inputName"
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="number" name="phone"
                                                                    value="{{ $dd->phone }}" class="form-control"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="email" name="email"
                                                                    value="{{ $dd->email }}" class="form-control"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="inputEmail"
                                                                class="col-sm-2 col-form-label">Parol</label>
                                                            <div class="col-sm-10">
