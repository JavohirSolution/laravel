...
<div class="wrapper">
  ...
  <div class='top-margin-auto'>
    ...
    <a href="/faylpdf" class="btn btn-outline-primary mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Add</a>
  ...
  <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form action="/addfayl" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <input type="file" accept=".pdf" name="pdf" class="form-control" id="exampleInputPassword1">
            </div>  
    ...
    @foreach($fayl as $dd)
      ...
      <tr>
        <td scope="row">{{$dd->id}}</td>
        <td>
          <a href="/pdf/{{$dd->image}}" target="_blank">ochish</a>
        </td>
        
        <td>
          <a href="/falydel/{{$dd->id}}" class='btn btn-danger'>Delete</a>
        </td>
      </tr>
    @endforeach
